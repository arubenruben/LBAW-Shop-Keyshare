    ...
    <div id="wrapper">
        <div class="container vh-100">
            <div class="row justify-content-center vh-100">
                <div class="col-12 col-sm-10 col-md-5 col-lg-5 p-4 my-auto"
                        ...
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls text-center">
                                    <a href="admin.php" id="signin" name="signin" class="btn text-light btn-orange"
        ...
        <div id="content" class="container">
            <div class="row mt-4 d-block d-lg-none">
                <div class="col-sm-12 text-center">
                    <button data-toggle="modal" data-target="#adminModal" class="btn btn-blue btn-md mt-2 ">Admin
                        Options</button>
                </div>
            </div>
    ...
    switch ($type) {
        ...
        case 0: ?>
                <div class="row justify-content-between flex-nowrap">
                    ...
                    <a href="admin_product_edit.php" class="btn btn-orange text-white mr-3" role="button"> <i
                            class="mr-1 fas fa-plus"></i> <span class="d-none d-md-inline-block">Add Product</span></a>
                </div>
                <?php break;
        //Categories Table
        case 1: 
    ...
    switch ($type) {
                ...
                <tbody>
                    ...
                    <tr>
                        <td scope="row" class="border-0 text-center align-middle">
                            <img src="../../../public/images/games/GTAV/1.png"
                        ...
                        <td class="align-middle">
                            <div class="btn-group-justified btn-group-md">
                                <a href="#" class="btn btn-blue btn-block flex-nowrap" data-toggle="modal"
                                    ...
                                    <i class="fas fa-edit d-inline-block"></i> <span
                                        class="d-none d-md-inline-block">Edit Category</span>
                                </a>
                        ...
                        <td class="align-middle">
                            <div class="btn-group-justified btn-group-md">
                                <button type="button mt-5 mb-5 " class="btn btn-blue btn-block flex-nowrap"
                                    ...
                                    <i class="fas fa-edit d-inline-block"></i> <span
                                        class="d-none d-md-inline-block">Edit Genre</span>
                                </button>
                                <button type="button mt-5 mb-5 " class="btn btn-red btn-block flex-nowrap"
                                    data-toggle="modal" data-target="#modalConfirm">
                                    <i class="fas fa-trash-alt"></i> <span class="d-none d-md-inline-block">Delete
                        ...
                        <td class="align-middle">
                            <div class="btn-group-justified btn-group-md">
                                <button type="button mt-5 mb-5 " class="btn btn-blue btn-block flex-nowrap"
                                    data-toggle="modal" data-target="#modalEdit">
                                    <i class="fas fa-edit d-inline-block"></i> <span
                                        class="d-none d-md-inline-block">Edit Platform</span>
                                </button>
                                <button type="button mt-5 mb-5 " class="btn btn-red btn-block flex-nowrap"
                                    data-toggle="modal" data-target="#modalConfirm">
                                    <i class="fas fa-trash-alt"></i> <span class="d-none d-md-inline-block">Delete
        ...
        case 4: ?>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="align-middle text-center">
                            <img src="https://scontent.flis7-1.fna.fbcdn.net/v/t1.0-9/22141173_826758350835332_1211921233867541017_n.jpg?_nc_cat=100&_nc_sid=85a577&_nc_ohc=FxTK4QbD1iIAX_KPa6o&_nc_ht=scontent.flis7-1.fna&oh=f273076c731a0cde48a147e1bc1c0308&oe=5E835F94"
                                class="img-fluid adminUserTableImage">
                        </td>
                        <td class="align-middle text-center">
                            <h6>Lockdownpt</h6>
                        </td>
                        <td class="align-middle">
                            <div class="btn-group-justified btn-group-md">
                                <button type="button mt-5 mb-5 " class="btn btn-red btn-block flex-nowrap"
                                    data-toggle="modal" data-target="#modalConfirm0">
                ...
                <table id="userOffersTable" class="table p-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <div class="btn-group-justified btn-group-md">
                                    <button type="button mt-5 mb-5 " class="btn btn-green btn-block flex-nowrap"
                                        data-toggle="modal" data-target="#modalConfirm1">
                                        <i class="fas fa-check"></i><span class="d-none d-md-inline-block">Unban
                                            User</span>
                                    </button>
                                </div>
                            </td>
                            ...
                            <td class="align-middle">
                                <div class="btn-group-justified btn-group-md">
                                    <button type="button mt-5 mb-5 "
                                        class="btn btn-outline-success btn-block flex-nowrap">
                                        <i class="fas fa-user-check"></i> <span class="d-none d-md-inline-block">Ban
                                            Lift</span>
                                    </button>
                                </div>
                            </td>
        ...
        case 6: ?>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="align-middle">
                                <div class="btn-group-justified btn-group-md">
                                    <a href="admin_report_page.php" type="button mt-5 mb-5"
                                        class="btn btn-outline-dark btn-block flex-nowrap">
                                        <span class="d-none d-md-inline-block">More Details</span><i
                                            class="ml-2 fas fa-arrow-circle-right"></i>
                                    </a>
                                </div>
                            </td>
                        </tr>
                            ...
                            <td class="align-middle">
                                <div class="btn-group-justified btn-group-md">
                                    <button type="button mt-5 mb-5 " class="btn btn-blue btn-block flex-nowrap"
                                        ...
                                        <i class="fas fa-info-circle"></i> <span class="d-none d-md-inline-block">View
                                            Details</span>
                                    </button>
                                    <button type="button mt-5 mb-5 " class="btn btn-red btn-block flex-nowrap"
                                        data-toggle="modal" data-target="#modalConfirm">
            ...
            drawEditPropertyModal("Edit Answer", "It works using the Bootstrap 4 collapse component with cards to make a vertical accordion that expands and collapses as questions are toggled.", "2"); ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center">
                                <h6>It works using the Bootstrap 4 collapse component with cards to make a vertical
                                    accordion that expands and collapses as questions are toggled.</h6>
                            </td>
                            <td class="align-middle">
                                <div class="btn-group-justified btn-group-md">
                                    <button type="button mt-5 mb-5 " class="btn btn-blue btn-block flex-nowrap"
                                        data-toggle="modal" data-target="#modalEdit1">
                                        <i class="fas fa-edit d-inline-block"></i> <span
                                            class="d-none d-md-inline-block">Edit Question</span>
                                    </button>
                                    <button type="button mt-5 mb-5 " class="btn btn-blue btn-block flex-nowrap"
                                        data-toggle="modal" data-target="#modalEdit2">
                                        <i class="fas fa-edit d-inline-block"></i> <span
                                            class="d-none d-md-inline-block">Edit Answer</span>
                                    </button>
                                    <button type="button mt-5 mb-5 " class="btn btn-red btn-block flex-nowrap"
                                        data-toggle="modal" data-target="#modalConfirm">
                                        <i class="fas fa-trash-alt"></i> <span class="d-none d-md-inline-block">Delete
    ...
    <form>
        <div class="row">
            <div class="col align-middle">
                ...
                <button id="uploadPhotoProduct" type="button"
                    class="btn btn-primary btn-block text-white bg-orange mt-2 ml-auto mr-auto">Upload File</button>
            </div>
        ...
        <div class="form-group col mb-auto mr-auto">
            ...
            <div class="input-group mb-3">
                ...
                <input id="gameGenres" type="text" class="form-control" aria-label="Text input with dropdown button"
                    value="Action,Simulation,Racing">
            </div>
        </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="col text-left"><button class="btn btn-blue"><i class="fas fa-check mr-2"></i> Confirm
                    </button></div>
