...
class ProductController extends Controller
{
    ...
    public function show($productName, $platformName) {
        ...
        return view('pages.products.product', ['user' => Auth::user(), 'product' => $product, 'platformName' => $platformName, 'offers' => $offers, 'pages' => array($product->name.'['.$platform->name.']'), 'links'=>array(url('/product/'.$product->name.'/'.$platform->name))]);
    }
