            ...
            <div class="col-10 mx-auto">
                <div class="accordion" id="faq">
                    ...
                    <div class="card my-2">
                        ...
                        <div id="faq1A" class="collapse show" aria-labelledby="faq1Q" data-parent="#faq">
                            <div class="card-body">
                    ...
                    <div class="card my-2">
                        ...
                        <div id="faq2A" class="collapse show" aria-labelledby="faq2Q" data-parent="#faq">
                            <div class="card-body">
                                <b>Answer:</b> It works using the Bootstrap 4 collapse component with cards to make a vertical accordion that expands and collapses as questions are toggled.
                            </div>
                        </div>
                    ...
                    <div class="card my-2">
                        ...
                        <div id="faq3A" class="collapse show" aria-labelledby="faq3Q" data-parent="#faq">
                            <div class="card-body">
                                <b>Answer:</b> It works using the Bootstrap 4 collapse component with cards to make a vertical accordion that expands and collapses as questions are toggled.
                            </div>
                        </div>
                    ...
                    <div class="card my-2">
                        ...
                        <div id="faq4A" class="collapse show" aria-labelledby="faq4Q" data-parent="#faq">
                            <div class="card-body">
                                <b>Answer:</b> It works using the Bootstrap 4 collapse component with cards to make a vertical accordion that expands and collapses as questions are toggled.
                            </div>
                        </div>
                    ...
                    <div class="card my-2">
                        ...
                        <div id="faq5A" class="collapse show" aria-labelledby="faq5Q" data-parent="#faq">
                            <div class="card-body">
                                <b>Answer:</b> It works using the Bootstrap 4 collapse component with cards to make a vertical accordion that expands and collapses as questions are toggled.
                            </div>
                        </div>
                    ...
                    <div class="card my-2">
                        <div class="card-header p-2" id="faq6Q">
                            <h5 class="mb-0">
                                <button class="btn btn-link cl-orange2" type="button" data-toggle="collapse" data-target="#faq6A" aria-expanded="false" aria-controls="faq6A">
                                Do I have access to the games I buy on the KeyShare website forever?
                                </button>
                            </h5>
                        </div>

                        <div id="faq6A" class="collapse show" aria-labelledby="faq6Q" data-parent="#faq">
                            <div class="card-body">
                                <b>Answer:</b> It works using the Bootstrap 4 collapse component with cards to make a vertical accordion that expands and collapses as questions are toggled.
                            </div>
                        </div>
