    ...
    <div id="content" class="container">
        <div class="row mt-5">
            ...
            <div class="col ml-auto mr-auto">
                <div class="row"> 
                    <!--Filters -->
                    <div class="row ml-3 d-block d-sm-none" data-toggle="modal" data-target="#mobileFilter">
                        <div class="sideBarButton">
                        <button class="btn btn-secondary btn-sm pl-4 py-2 pr-4" type="button"> <i class="fas fa-filter"></i> Filters</button>
                        </div>
                    </div>
                    <!--First Row-->
...
<?php function drawFilterSideBar(){ ?>   
    <!-- Modal -->
	<div class="modal left fade" id="mobileFilter" tabindex="-1" role="dialog" aria-labelledby="mobileFilter">
		<div class="modal-dialog" role="document">
			<div class="modal-content">

				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title" id="mobileFilter">Left Sidebar</h4>
				</div>
