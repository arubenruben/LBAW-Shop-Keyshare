...
<?php function drawProductOffer() { ?>
    <tr class="offer">
        ...
        <td class="text-center align-middle">
            ...
            <button type="button" class="btn btn-orange deleteButtonCheckout" data-container="body" data-toggle="popover" data-trigger="focus" title="<span class='cl-success'>Successfully added to your cart</span>" data-placement="bottom" data-content="Click <a href='cart.php'>here</a> to go to your cart"><i class="fas fa-shopping-cart"></i> <span> Add to Cart </span></button>
            </div>
        </td>
    </tr>
<?php } ?>