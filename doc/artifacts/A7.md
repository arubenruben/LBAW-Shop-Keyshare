...
<table id="r101">
    ...
    <tr>
        ...
        <td colspan="4">Page with a form to login.</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="2">UI</td>
        <td colspan="4"><a href="">UI07 Sign in/up</a></td>
    </tr>
    <tr>
        <td colspan="2">Submit</td>
        <td colspan="4"><a href="">R102</a></td>
    </tr>
    <tr>
...
<table id="r103">
    ...
    <tr>
        <td colspan="2">Description</td>
        <td colspan="4">Page with a form to register to a user account.</td>
    </tr>
    <tr>
        <td colspan="2">Method</td>
        <td colspan="4">GET</td>
...
<table id="r104">
  ...
  <tr>
   ...
   <tr>
      <td colspan="2">+passwordConfirm: string</td>
      <td colspan="2">Password confirmation</td>
  </tr>
  <tr>
      <td colspan="2">Redirects</td>
      <td colspan="2">Current Page</td>
...
<table id="r109">
  ...
  <tr>
    <td colspan="2">Description</td>
    <td colspan="4">Action to submit the logout request.</td>
  </tr>
  <tr>
      <td colspan="2">Method</td>
      <td colspan="4">POST</td>
...
<table id="r110">
  <tr>
    <td colspan="2">URL</td>
    <td colspan="4">/admin/logout</td>
  </tr>
  <tr>
    <td colspan="2">Description</td>
    <td colspan="4">Action to submit the logout request for an admin account.</td>
  </tr>
  <tr>
      <td colspan="2">Method</td>
      <td colspan="4">POST</td>
...
* R201:User Homepage/User Edit View [/user/{id}]
...
* R206:User Delete Profile Picture Action[/user/{id}/image]
* R207:User Update profile [/user/{id}/]
...
<table id = "r201">
    ...
    <tr>
        ...
        <td colspan="2">R207 is called when anykind of updat.</td>
    </tr>
    <tr>
        <td colspan="2">Permissions</td>
...
<table id = "r207">
  ...
  <tr>
    <td colspan="2">Description</td>
    <td colspan="4">Action executed when an update to the user personal information occurs.</td>
  </tr>
  <tr>
      <td colspan="2">Method</td>
      <td colspan="4">PUT</td>
...
<table id = "r402">
  <tr>
    <td colspan="2">URL</td>
    <td colspan="4">/search/{page}/{filters}</td>
  </tr>
  <tr>
    <td colspan="2">Description</td>
    <td colspan="4">Page that will allow the user to navigate through and choose products</td>
  ...
  <tr>
   ...
   <tr>
      ...
      <td colspan="2">Current page searching</td>
  </tr>
   <tr>
      <td colspan="3">?filters: array</td>
      <td colspan="2">Different types of search filters applied</td>
  </tr>
  <tr>
      <td colspan="2">UI</td>
...
<table id="r404">
  <tr>
    <td colspan="2">URL</td>
    <td colspan="4">product/search/</td>
  </tr>
  <tr>
    <td colspan="2">Description</td>
  ...
  <tr>
      <td colspan="2" rowspan="7">Request Body</td>
      <td colspan="2">?searchString: string</td>
      <td colspan="2">String inserted in the search bar with the search query</td>
  </tr>
  <tr>
      <td colspan="2">?genres: array</td>
  ...
  <tr>
      ...
      <td colspan="2">+orderingParameter: string</td>
      <td colspan="2">Order parameter to define the way the results of the search will be presented</td>
  </tr>
  <tr>
      <td colspan="2" rowspan="2">Redirects</td>
      <td colspan="2"><a href="">R402</a></td>
      <td colspan="2">Success</td>
  </tr>
   <tr>
      <td colspan="2"><a href >R402</a></td>
...
<table id="r504">
    <tr>
        <td colspan="2">URL</td>
        <td colspan="4">/cart/checkout/{currentStep} </td>
    </tr>
    <tr>
        <td colspan="2">Description</td>
