...
INSERT INTO products(name,description, category_id, picture_id,deleted,launch_date)VALUES (UPPER('Project CARS 2'), 'THE ULTIMATE DRIVER JOURNEY! Project CARS 2 delivers the soul of motor racing in the world’s most beautiful, authentic, and technically-advanced racing game.', 1, 2, FALSE, '2018-12-15 06:42:26');
...
INSERT INTO products(name,description, category_id, picture_id,deleted, launch_date)VALUES (UPPER('DRAGON BALL FighterZ'), 'DRAGON BALL FighterZ is born from what makes the DRAGON BALL series so loved and famous: endless spectacular fights with its all-powerful fighters.', 1, 2, TRUE, '2018-12-15 06:42:26');
