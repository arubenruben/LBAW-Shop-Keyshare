<tr id={{'row'.$data->id}}>
    ...
    <td class="align-middle">
        <section class="btn-group-justified btn-group-md">
            <button class="btn btn-red btn-block flex-nowrap remove_cart_button" data_cart_id={{$data->id}}><i class="fa fa-trash cl-fail"></i> <span class="d-none d-md-inline-block">Delete</span></button>
        </section>
    </td>
</tr>