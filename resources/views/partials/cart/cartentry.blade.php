<tr id={{'row'.$data->id}}>
    <td scope="row" class="border-0 align-middle">
        <section class="p-2">
            <a href="product.php"><img src="/pictures/games/{{$data->offer->product->picture->url}}" alt="" width="150" class="img-fluid rounded shadow-sm d-none d-sm-inline userOffersTableEntryImage"></a>
