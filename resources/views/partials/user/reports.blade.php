                                                ...
                                                <div class="ml-3 d-inline-block align-middle">
                                                    <div class="flex-nowrap">
                                                        <h5 class="mb-0 d-inline-block"><a
                                                                href="{{ url('/product/'.$myReport->key->offer->product->id.'/'.$myReport->key->offer->platform->id) }}"
                                                    ...
                                                    </div><a href="/user/{{$myReport->key->offer->seller->username}}"
