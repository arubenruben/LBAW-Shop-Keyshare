                            ...
                            <table id="userOffersTable" class="table p-0">
                                ...
                                <tr>
                                    <th scope="row" class="border-0 align-middle">
                                        <div class="p-2">
                                            <img src="{{'/images/games/original/'.$myReport->key->offer->product->picture->url}}" alt="" width="150" class="img-fluid rounded shadow-sm d-none d-sm-inline userOffersTableEntryImage">
