            ...
            <div class="row mt-4">
                ...
                <div class="col-6 text-right">
                    ...
                    <div class="custom-control custom-radio my-2 ml-3" style="display:inline;">
                        <input type="radio" class="custom-control-input sort-by" id="SortBy1" name="sort_by" value="Best Price">
                        <label class="custom-control-label" for="SortBy1">Best Price</label>
                    </div>
                    <div class="custom-control custom-radio my-2 ml-3" style="display:inline;">
                        <input type="radio" class="custom-control-input sort-by" id="SortBy2" name="sort_by" value="Best Rating">
                ...
                <div class="col-12">
                    <div class="table-responsive table-striped ">
                        <table id="userOffersTable" class="table p-0">
                            <thead>
                            <tr>
                                <th scope="col" class="border-0 bg-light"><div class="p-2 px-3 text-uppercase">Seller Details</div></th>
                                <th scope="col" class="border-0 bg-light text-center"><div class="py-2 text-uppercase">Price</div></th>
                                <th scope="col" class="border-0 bg-light text-center"><div class="py-3 text-uppercase"></div></th>
                            </tr>
                            </thead>
