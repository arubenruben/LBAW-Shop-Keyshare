<article>
    <header class="row">
        ...
        <div class="col-4 d-flex justify-content-end my-auto mw-100 mh-100">
            <a id="left-most-popular"  href="#carouselPopular"  data-slide="prev"  class="btn btn-light rounded-circle ml-auto" role="button" onclick="blur();">
                <i class="fas fa-angle-left"></i>
            </a>
            <a id="right-most-popular"  href="#carouselPopular"  data-slide="next" class="btn btn-light rounded-circle" role="button" onclick="blur();">
