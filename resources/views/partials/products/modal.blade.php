                                ...
                                <section>
                                    ...
                                    <div id="collapseOrder" class="collapse show">
                                        <div class="custom-control custom-radio my-2 ml-3">
                                            <input type="radio" class="custom-control-input sort-by" id="SortBy11" name="sort_by" value="Highest Price">
                                            <label class="custom-control-label" for="SortBy11">Highest Price</label>
                                        </div>
                                        <div class="custom-control custom-radio my-2 ml-3">
                                            <input type="radio" class="custom-control-input sort-by" id="SortBy22" name="sort_by" value="Lowest Price">
                                            <label class="custom-control-label" for="SortBy22">Lowest Price</label>
                                        </div>
                                        <div class="custom-control custom-radio my-2 ml-3">
                                            <input type="radio" class="custom-control-input sort-by" id="SortBy33" name="sort_by" value="Most popular">
                                            <label class="custom-control-label" for="SortBy33">Most popular</label>
                                        </div>
                                        <div class="custom-control custom-radio my-2 ml-3">
                                            <input type="radio" class="custom-control-input sort-by" id="SortBy44" name="sort_by" value="Most recent">
                                    ...
                                    <div id="collapseGenres" class="collapse show">
                                        ...
                                        @foreach($genres as $genre)
                                            ...
                                            <div class="custom-control custom-checkbox row ml-3 my-2">
                                                <input type="checkbox" class="custom-control-input genre" id="checkBoxGenre{{$i}}{{$i}}" value="{{$genre->name}}">
                                                <label class="custom-control-label" for="checkBoxGenre{{$i}}{{$i}}">{{$genre->name}}</label>
                                            </div>
                                        @endforeach
                                    </div>
                                    <hr>
                                ...
                                <section class="mt-4">
                                    ...
                                    <div id="collapsePlatforms" class="collapse show">
                                        ...
                                        @foreach($platforms as $platform)
                                            @php $i++; @endphp
                                            <div class="custom-control custom-radio my-2 ml-3">
                                                <input type="radio" class="custom-control-input platform" id="checkBoxPlatforms{{$i}}{{$i}}" name="platform" value="{{$platform->name}}">
                                                <label class="custom-control-label" for="checkBoxPlatforms{{$i}}{{$i}}">{{$platform->name}}</label>
                                            </div>
                                        @endforeach
                                    </div>
                                    <hr>
                                    ...
                                    <div id="collapseCategories" class="collapse show">
                                        ...
                                        @foreach($categories as $category)
                                            ...
                                            <div class="custom-control custom-radio row ml-3 my-2">
                                                <input type="radio" class="custom-control-input category" id="checkBoxCategories{{$i}}{{$i}}" name="category" value="{{$category->name}}">
                                                <label class="custom-control-label" for="checkBoxCategories{{$i}}{{$i}}">{{$category->name}}</label>
                                            </div>
                                        @endforeach
                                    </div>
                                    <hr>
