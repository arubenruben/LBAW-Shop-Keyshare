    ...
    <div class="mt-auto">
        <form class="form-horizontal" action="{{ url('/login') }}" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="usernameLogIn" name="username" type="text" class="form-control input-medium"
            ...
            <div class="control-group mt-4 mb-2">
                ...
                <div class="controls">
                    <input required="" id="passwordLogIn" name="password" class="form-control input-medium" type="password"
                        placeholder="********">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls text-center">
                    <button id="login" name="login" class="btn btn-lg text-light btn-orange" formmethod="post">Log in</button>
                </div>
            </div>
        </form>
