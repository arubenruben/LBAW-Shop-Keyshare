    ...
    <div class="mt-auto">
        <form class="form-horizontal" action="{{ url('/register') }}" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="usernameSignUp" name="username" type="text" class="form-control input-medium"
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="password_confirmation" class="form-control input-large" name="password_confirmation"
